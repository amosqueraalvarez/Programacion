ficheiro = open(
    '/home/dam/PROG/boletines/ejercicios-programacion-castelao/ejercicios clase/ficheiros/saudo.txt', 'r')
print(ficheiro.read())
ficheiro.close()

ficheiro = open(
    '/home/dam/PROG/boletines/ejercicios-programacion-castelao/ejercicios clase/ficheiros/saudo.txt', 'a')
